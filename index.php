...
<body class="about-us bg-gray-100">
  ...
  <header class="bg-gradient-dark">
    <div class="page-header min-vh-75" style="background-image: url('Image/background.jpg');">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <!-- <img src="Image/logo.svg" alt=""> -->
            <h1 class="text-white">Coontrera</h1>
            <p class="lead mb-4 text-white opacity-8">Renove sua energia com resultados incríveis e uma rotina de bem-estar que você vai amar!</p>
